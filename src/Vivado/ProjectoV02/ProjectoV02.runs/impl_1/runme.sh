...
HD_PWD='C:/Users/Mi/SEP2024_local/JuegoRitmoFPGA/src/Vivado/ProjectoV02/ProjectoV02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BDv1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BDv1_wrapper.tcl -notrace
