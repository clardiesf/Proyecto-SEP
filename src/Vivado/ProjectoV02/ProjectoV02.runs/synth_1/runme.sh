...
HD_PWD='C:/Users/Mi/SEP2024_local/JuegoRitmoFPGA/src/Vivado/ProjectoV02/ProjectoV02.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BDv1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BDv1_wrapper.tcl
