...
HD_PWD='C:/Users/Mi/SEP2024_local/JuegoRitmoFPGA/src/Vivado/ProjectoV02/ProjectoV02.runs/BDv1_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BDv1_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BDv1_xbar_0.tcl
